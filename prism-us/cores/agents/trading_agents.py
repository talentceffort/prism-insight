...

{
    ...
    "rationale": "진입 시 진입근거를 최소 3개 이상 각각 구분해 명시(펀더/모멘텀/추세/촉매/수급 중 3가지 이상). 미진입 시엔 핵심 판단 근거를 간결히.",
...

{
    ...
    "rationale": "On ENTRY, give at least 3 distinct entry rationale points (fundamentals / momentum / trend / catalyst / flow — name 3+ separately). On no-entry, state the key reasoning concisely.",
